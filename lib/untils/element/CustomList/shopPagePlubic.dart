...
class ListPagePlubic extends StatefulWidget {
  final List data;
  ListPagePlubic({
    this.data
  });
  @override
  _ListPagePlubicState createState() => _ListPagePlubicState();
}

class _ListPagePlubicState extends State<ListPagePlubic> {
...
//              type: _data[i]['type'] !=null ? _data[i]['type'] :0,
//              categoryList: _data[i]['categoryList'] !=null ? _data[i]['categoryList']:[],
//              brandList: _data[i]['brandLists']  !=null  ?_data[i]['brandLists']:[],
              ),
          );
          break;
