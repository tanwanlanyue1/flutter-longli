...
class BrandCustom extends StatefulWidget {
  var BrandCustomID;
  BrandCustom({this.BrandCustomID});
  @override
  _BrandCustomState createState() => _BrandCustomState();
}

class _BrandCustomState extends State<BrandCustom> {
...
//        print( "_data[i]['data']==>${_data[i]['data']}");
  ...
  List<Widget> _page(){
    ...
    _allPage.add(SingleChildScrollView(
      child: Column(children: _pageList(),),
    ));
    for(var i = 0; i <_data.length; i++){
