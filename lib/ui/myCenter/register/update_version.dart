              ...
              Container(
                  ...
                  child: Column(children: <Widget>[
                    ClipRRect(
                        ...
                        child: Image.asset(
                          "images/setting/ic_update_bg.png",
                          height: 110,
                    ...
                    Padding(
                        ...
                        child: Center(
                            child: new Text('${_TestModel.UpdatingS == true?"请您先":''}升级到新版本',
                                style: new TextStyle(
                                  fontSize: 17.0,
                    ...
                    _TestModel.UpdatingS == true
                        ?Container( padding: EdgeInsets.fromLTRB(0, 8, 0, 10),)
                        :Padding(
