...
//会员服务协议
class VipRulePage extends StatefulWidget {
  @override
  _VipRulePageState createState() => _VipRulePageState();
}

class _VipRulePageState extends State<VipRulePage> {
  @override
        ...
        child: Row(
          children: <Widget>[
            ...
            InkWell(
              child: Container(
                alignment: Alignment.centerLeft,
                child: Text("   会员服务协议",style: TextStyle(fontSize: ScreenUtil().setSp(40),color: Color.fromRGBO(27, 27, 27, 1)),),
              ),
              onTap: (){
                Navigator.pop(context);
              },
